...
const LaporanKemenag = () => {
    ...
    const fetchStats = useCallback(async () => {
        try {
            setLoading(true);
            // Ideally this should point to a Kemenag specific endpoint or inclusive endpoint
            // For now attempting /submissions/analytics or fall back to filtered existing data
            ...
            // Don't clear stats entirely on error if we want to show empty state
            setStats({
                total: 0,
                submitted: 0,
                processing: 0,
